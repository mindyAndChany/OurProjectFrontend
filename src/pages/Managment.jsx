...
const Managment = () => {
  ...
  // ======= הוספה: תרגום שמות מסכים לעברית =======
  const SCREEN_NAME_HE = {
    approvals: 'אישורים',
    Calendar: 'לוח שנה',
    HomePage: 'דף הבית',
    // הוסיפי כאן מסכים נוספים שמגיעים באנגלית
  };

  const getHebrewScreenName = (screenName) => {
    if (!screenName) return '-';
    return SCREEN_NAME_HE[screenName] ?? screenName;
  };
  // ==============================================
